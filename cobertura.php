...
<body>
  ...
  -->
    ...
    <div class="main-panel">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">COBERTURA</a>
          </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              ...
              <p class="card-category">Veja os locais onde prestamos atendimento...
              </p>
            </div>
			   <div class="card-body">
                 <div class="row">
	  ...
	  <font size="+3"><strong> BAIRROS:</strong></font>
	                     <BR>
						  <br>
						   <p>
						    <font size="+1">
						 ...
						 Apaxe do tororó<br>
						 barris<br>
						 Av Joana angelica<br>
						 Mouraria<br>
						 Independencia<br>
						 Gravatá<br>
						 Jardim bahiano<br>
						 Baixa dos sapateiros<br>
						 Centro historico 'algumas ruas'<br>
						 Alto das pombas<br>
						 Calaba<br>
						 <br>
						    </p>
						   <br>
						 <p>Em breve estaremos atendendo no:<br>
						 Saúde<br>
						 Nazaré<br>
						 Av sete<br>
						 Piedade<br>
