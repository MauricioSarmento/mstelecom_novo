...
<div class="image-container set-full-height" style="background-image: url('assets/img/wizard-city.jpg')">
	...
	<!--  Made With Get Shit Done Kit  -->
		<a href="http://mstelecom.org" class="made-with-mk">
			<div class="brand">MS</div>
			<div class="made-with">MSTELECOM <strong>!</strong></div>
		</a>
<br>
<br>
...
<!------------------------------------------------------------------------------------------------------------------------------------------------>	                                 
								  ...
								  <div class="col-sm-6">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <input name="cpf" value="<?php echo $cpf; ?>" type="number_format" class="form-control" onkeypress="$(this).mask('000.000.000-00');" placeholder="000.000.000-00...">
                                      </div>
                                  </div>
								  ...
								  <div class="col-sm-10 col-sm-offset-1">
                                      <div class="form-group">
                                          ...
                                          <input name="email" value="<?php echo $email; ?>" type="email" class="form-control" placeholder="exemplo@mstelecom.org">
                                      </div>
                                  </div>
<!------------------------------------------------------------------------------------------------------------------------------------------------>								  
<!------------------------------------------------------------------------------------------------------------------------------------------------>								  
                            ...
                            <div class="tab-pane" id="about">
                              <div class="row">
								  ...
								  <div class="col-sm-10 col-sm-offset-1">
                                      <div class="form-group">
                                          <label>E-mail <small>(required)</small></label>
                                          <input name="email" type="text" class="form-control" placeholder="exemplo@mstelecom.org">
                                      </div>
                                  </div>
                            ...
                            <div class="tab-pane" id="account">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-radio" type="checkbox" rel="tooltip" title="Select this option if you or a certified captain will be included.">
                                                <input type="radio" class="form-control " name="plano" value="8M">
                                                <div class="icon">
                                                     <i>8 MB</i>
                                                </div>
                                                </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select this option if you or a certified captain will be included.">
                                                <input type="checkbox" class="form-control " name="plano" value="10M">
                                                <div class="icon">
                                                     <i>10 MB</i>
                                                </div>
                                                </div>
										...
										<div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select this option if you or a certified captain will be included.">
                                                <input type="checkbox" class="form-control " name="plano" value="15M">
                                                <div class="icon">
                                                     <i>15 MB</i>
                                                </div>
                                                </div>
										...
										<div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select this option if you or a certified captain will be included.">
                                                <input type="radio" class="form-control " name="plano" value="20M">
                                                <div class="icon">
                                                     <i>20 MB</i>
                                                </div>
                                                </div>
										...
										<div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select this option if you or a certified captain will be included.">
                                                <input type="radio" class="form-control " name="plano" value="30M">
                                                <div class="icon">
                                                     <i>30 MB</i>
                                                </div>
                                                </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="choice" data-toggle="wizard-radio" rel="tooltip" title="Select this option if you or a certified captain will be included.">
                                                <input type="radio" class="form-control " name="plano" value="50M">
                                                <div class="icon">
                                                     <i>50 MB</i>
                                                </div>
                                                </div>
...
?>
    ...
    <div class="footer">
        <div class="container">
            Se DEUS é por nós <i class="fa fa-heart heart"></i> quém <a href="http://mstelecom.org">será</a> contra nós? <a href="http://mstelecom.org"></a>
        </div>
    </div>
