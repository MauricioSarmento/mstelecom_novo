...
<?php   
include "pagamentos_sociedade.php";  ?></center>
</div>
</div>
</div>
</div>
...
$res=mysqli_query($con,$sql);	
$res=mysqli_query($con,"insert into historico values
(default, '$nome1','$n1', '$id_servserv',NOW(),'Removendo Sociedade Jurlan', '$user' ,'$endereco' ,'$complemento','$p4','$contato',
'$data_hora','$numero', '$c4','$valor2','$id_cliente','$bairro','$cpf','$email' );");	
}}
if($sociedade == 'Não'){
if($socio == 'Bimbo'){	
...
$res=mysqli_query($con,$sql);	
$res=mysqli_query($con,"insert into historico values
(default, '$nome1','$n1', '$id_servserv',NOW(),'Removendo Sociedade Bimbo', '$user' ,'$endereco' ,'$complemento','$p4','$contato',
'$data_hora','$numero', '$c4','$valor2','$id_cliente','$bairro','$cpf','$email' );");	
}}
if($sociedade == 'Bimbo'){
$data_hora = date('d-m-y H:i:s');		
...
echo "<button><a href='http://$servidor_mikrotik:8099/graphs/queue/<pppoe-$n1>/' target='_blank' class='form-control'>Grafico</a></button>";?>
</td>
</tr>
<td>
<br>
