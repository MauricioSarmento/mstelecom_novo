...
if($val == 3){$st = "<font color='#00CC00'> <center><button type='button' class='btn btn-success'>$mensalidade</button></center></font>";};
///////////////////////////////////////////////////
echo "<tbody><tr><td><a href='acao.php?id=$busca_usuario' class='form-control' target='_blank'><table border='0' width='250'>" . $busca_nome ;
echo "</table></center></a></td>";
echo "<td><a href='acao.php?id=$busca_usuario' class='form-control' target='_blank'><table border='0' width='250'>" . $busca_usuario ;
echo "</table></center></a></td>";
echo "<td><a href='acao.php?id=$busca_usuario' class='form-control' target='_blank'><table border='0' width='15'>" . $address ;
echo "</table></center></a></td>";
echo 		"<td><a href='acao.php?id=$n' class='form-control' target='_blank'><table border='0' width='15'>".$tempo."</table></center></a></td>";
