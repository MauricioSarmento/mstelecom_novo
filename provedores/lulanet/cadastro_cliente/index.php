...
<div class="image-container set-full-height" style="background-image: url('assets/img/wizard-city.jpg')">
    ...
    <a href="http://MSTELECOM.ORG/provedores/lulanet">
	...
	<!--  Made With Get Shit Done Kit  -->
		<a href="http://MSTELECOM.ORG/provedores/lulanet" class="made-with-mk">
			<div class="brand">MS</div>
			<div class="made-with">LULA_NET <strong>!</strong></div>
		</a>
<br>
<br>
...
<!------------------------------------------------------------------------------------------------------------------------------------------------>	                                 
								  ...
								  <div class="col-sm-10 col-sm-offset-1">
                                      <div class="form-group">
                                          ...
                                          <input name="email" value="<?php echo $email; ?>" type="email" class="form-control" placeholder="exemplo@MSTELECOM.ORG/provedores/lulanet">
                                      </div>
                                  </div>
<!------------------------------------------------------------------------------------------------------------------------------------------------>								  
<!------------------------------------------------------------------------------------------------------------------------------------------------>								  
                            ...
                            <div class="tab-pane" id="about">
                              <div class="row">
								  ...
								  <div class="col-sm-10 col-sm-offset-1">
                                      <div class="form-group">
                                          <label>E-mail <small>(required)</small></label>
                                          <input name="email" type="text" class="form-control" placeholder="exemplo@MSTELECOM.ORG/provedores/lulanet">
                                      </div>
                                  </div>
...
?>
    ...
    <div class="footer">
        <div class="container">
            Se DEUS é por nós <i class="fa fa-heart heart"></i> quém <a href="http://MSTELECOM.ORG/provedores/lulanet">será</a> contra nós? <a href="http://MSTELECOM.ORG/provedores/lulanet"></a>
        </div>
    </div>
