...
while($vreg=mysqli_fetch_row($res)){
$user1 = $vreg[1];
$priv=$vreg[6];}	 if($priv == 3 or $priv == 1 ) { 
	 	echo '
		<br>
		<br>
		<br>
...
<h4 class="card-title mt-0"> Pagamento</h4>
<p class="card-category"> Efetuado na mão dos técnicos</p>
              </div>
...
$status=$vreg[7];
$user=$vreg[2];
//$sql="UPDATE pagamento_sociedade SET status = '2' WHERE usuario ='$user'";
$res222=mysqli_query($con,$sql);
if($status == 1){
echo "<tr><td><a href='acao.php?id=$vreg[2]' target='_blank''><font color=red>" . $nome=$vreg[1] . '</font></a></td>';
echo "<td><a href='acao.php?id=$vreg[2]' target='_blank'><font color=red>" . $user=$vreg[2] . '</font></a></td>';
echo "<td><a href='acao.php?id=$vreg[2]' target='_blank'><font color=red>" . $forma=$vreg[3] . '</font></a></td>';
echo "<td><a href='acao.php?id=$vreg[2]' target='_blank'><font color=red>" . $data=$vreg[4] . '</font></td>';
echo "<td><a href='acao.php?id=$vreg[2]' target='_blank'><font color=red>" . $tec=$vreg[5] . '</font></a></td>';
echo "<td><a href='acao.php?id=$vreg[2]' target='_blank'><font color=red>" . $obs=$vreg[6] . '</font></a></td></tr>';
	}
	else
	{
		echo '<tr><td><font color=gree>' . $nome=$vreg[1] . '</font></td>';
echo '<td><font color=gree>' . $user=$vreg[2] . '</font></td>';
echo '<td><font color=gree>' . $forma=$vreg[3] . '</font></td>';
echo '<td><font color=gree>' . $data=$vreg[4] . '</font></td>';
echo '<td><font color=gree>' . $tec=$vreg[5] . '</font></td>';
echo '<td><font color=gree>' . $obs=$vreg[6] . '</font></td></tr>';
	}
	}
	echo '</table>';	
