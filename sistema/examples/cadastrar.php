...
<h4 class="card-title">Criar Cliente</h4>
<p class="card-category">Preencha as informações do cliente.aaaa</p>
</div>
...
<td>
<input type="text" class="form-control" name="nome1"   placeholder="Nome completo" onchange="carregatexto(this.value)" />
</td>
...
<td>
<input type="text" name="cpf" placeholder="000.000.000-00" class="form-control" onkeypress="$(this).mask('000.000.000-00');" size="30" maxlength="18"  onchange="carregatexto(this.value)" />
</td>
...
<td>
<input type="text" class="form-control" name="email" size="30" maxlength="35" placeholder="exemplo@mstelecom.org" onchange="carregatexto(this.value)" />
</td>
...
<td>
<input type="text" class="form-control" name="endereco" size="30" maxlength="200" placeholder="Rua amparo do tororó" onchange="carregatexto(this.value)" />
</td>
...
<td>
<input type="text" class="form-control" name="numero" size="30" maxlength="35" placeholder="777" onchange="carregatexto(this.value)" />
</td>
</tr>
<tr>
</tr>
...
<td>
<input type="text" class="form-control" name="complemento" size="30" maxlength="55" placeholder="Centro" onchange="carregatexto(this.value)" />
</td>

<td>
<font color='black' class="bmd-label-floating"><strong>Telefone:</strong></font>
</td>
<td>
<input type="text" class="form-control" name="telefone" size="30" maxlength="50" placeholder="71 00000-0000" onchange="carregatexto(this.value)" />
</td>
...
<td>
<input type="txt" class="form-control" name="instalacao" size="25" maxlength="35" value="<?php echo $d = date("d/m/Y");?>" onchange="carregatexto(this.value)" />
</td>
</tr>
<tr>
</tr>
...
<td>
<select name="Vecimento" class="form-control" id="select">
<option>05</option>
<option>10</option>
<option>15</option>
<option>20</option>
...
<td>
<input type="text" class="form-control" name="valor" size="30" maxlength="25" placeholder="00,00" onchange="carregatexto(this.value)" onkeypress="$(this).mask('#.##0,00', {reverse: true});" />
</td>
...
$plano=$_POST["plano"];}
if(isset($_POST["Vecimento"])){
$Vecimento=$_POST["Vecimento"];}
...
if($num !== $num2 ){
echo " <center> <font color='#00CC00'>Usuario criado com sucesso na RB!</font> <br>
<a href='acao.php?id=$usuario'> 
<button type='submit' class='btn btn-primary pull-right'>Ir para cadastro</button>
</li></center>";
}
