...
<td>
<input type="txt" class="form-control" name="roteador" size="25" maxlength="50" value=""/>
</td>
...
<td>
<input type="txt" class="form-control" name="marca" size="25" maxlength="50" value=""/>
</td>
...
<td>
<input type="txt" class="form-control" name="cliente" size="25" maxlength="50" value=""/>
</td>
...
<td>
<input type="txt" class="form-control" name="data" size="25" maxlength="50" value="<?php echo date('d-m-y');  ?>"/>
</td>
...
$res=mysqli_query($con,"insert into roteador_teste values
(default, '$roteador', '$marca', '$cliente', '$data');");
}
echo 'ROTEADORES CADASTRADOS <BR>
...
';
$sql="SELECT * FROM roteador_teste";
$res=mysqli_query($con,$sql);
while($vreg=mysqli_fetch_row($res)){
	$id_roteador = $vreg[0];
...
<form name="login" method="post" action="" >
<input type="hidden" name="get" value="nada" /> 
<input type="checkbox" class="form-control checkgroup"  name="remover" value="sim">
</td><td>
<button type="submit" class="btn btn-primary pull-right">REMOVER</button>
<?php
if(isset($_POST["remover"])){
$remover=$_POST["remover"];
if($remover == 'sim'){
$sql="delete FROM roteador_teste where id_roteador = $id_roteador";
$res=mysqli_query($con,$sql);	
echo '</center></td></tr>';
}
}
