...
<br>
<br>
OBD: colocar . no valor em vez de ,
...
<td>
<input type="txt" class="form-control" name="produto" size="25" maxlength="50" value=""/>
</td>
...
<td>
<input type="txt" class="form-control" name="p_compra" size="25" maxlength="50" value=""/>
</td>
...
<td>
<input type="txt" class="form-control" name="lucro" size="25" maxlength="50" value=""/>
</td>
...
<td>
<input type="txt" class="form-control" name="categoria" size="25" maxlength="50" value=""/>
</td>
...
<td>
CADASTRAR OU ADICIONAR
</td>
<td>
<select name="cd" class="form-control" id="select" >
<option>Selecione</option>
<option>Add estoque</option>
<option>Novo</option>
</select>
</td>
</tr>
...
if(isset($_POST["p_compra"])){
$p_compra=$_POST["p_compra"];}
if(isset($_POST["p_venda"])){
$p_venda=$_POST["p_venda"];}
if(isset($_POST["lucro"])){
$lucro=$_POST["lucro"];}
if($lucro == ''){$lucro= $p_venda - $p_compra;}
if(isset($_POST["categoria"])){
$categoria=$_POST["categoria"];}
if(isset($_POST["nota"])){
$nota=$_POST["nota"];}
///////////////////CADASTRANDO PRODUTO NO BANCO DE DADOS\\\\\\\\\\
$data_hora = date('d-m-y');

if(isset($_POST["cd"])){
$cd=$_POST["cd"];}
if($cd == 'Novo'){
$res=mysqli_query($con,"insert into produtos values
(default, '$produto','$quantidade','$p_compra', '$p_venda', '$lucro', '$categoria', '$nota', '$data_hora');");
}else{if(
$cd == 'Add estoque'){
...
$data_hora = date('d-m-y');
$sql="UPDATE produtos SET quantidade = '$quantidade' , preço_compra = '$p_compra' , preço_venda = '$p_venda' , lucro = '$lucro' , nota = '$nota' , data = '$data_hora' where item = '$produto' ";
$res=mysqli_query($con,$sql);
////////////SALVANDO PRODUTO ANTIGO\\\\\\\\\\
$produto_ant = $produto . '_antigo' . $id;
$res=mysqli_query($con,"insert into produtos values
(default, '$produto_ant','0','$compra_antigo', '$venda_antigo', '$lucro_antigo', '$cat_antigo', '$nota_antigo', '$data_antigo');");
}
}
}
