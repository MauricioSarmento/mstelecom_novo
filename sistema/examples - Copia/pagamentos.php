...
(NULL, '$nome','$n', '$id_servserv',NOW(),'Pagamento', '$user' ,'$endereço' ,'$complemento','$plano','$tel','$data_hora', '$numero', '$ven','$valor','$apelido' );");
...
(NULL, '$id_servidor' , '$id' , '$data_m' , '$data_y' , '$valor' , '$ven' , '$data_hora');");	
}
}//////////////////////////////
///////////////////////////////
///////////////////////////////
