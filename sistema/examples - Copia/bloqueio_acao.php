...
<!--- ATUALIZAÇÕES -->
			  ...
			  <center>
<BR> 
O PERFIL DO CLIENTE IRAR MUDAR PARA BLOQUEIO, BASTA SELECIONAR O NOME DO CLIENTE.</p>
<center>
<table width="449">
<td><center>
...
(default, '$nome','$n', '$id_servserv',NOW(),'Bloqueio', '$user' ,'$endereço' ,'$complemento','$plano','$tel','$data_hora', '$numero', '$ven','$valor','$apelido' );");
...
<?php
echo "<p><center> <a href='acao.php?id=$n3'> <button type='button' class='btn btn-primary'>Voltar</button></a></center></p>";?>
</br>
