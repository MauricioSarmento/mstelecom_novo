      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">SOBRE NÓS</a>
          </div>
        ...
        <div class="container-fluid">
          <div class="card">
            <div class="card-header card-header-primary">
              <h3 class="card-title">QUÉM SOMOS</h3>
              <p class="card-category">Veja as nossas informações e fique sabendo mais sobre nós...
              </p>
            </div>
			   <div class="card-body">
                 <div class="row">
