                              ...
                              <div class="row">
                                  ...
                                  <div class="col-sm-4 col-sm-offset-1">
                                     <div class="picture-container">
                                          ...
                                          <h6><?php if($plano == null){echo '<input type="checkbox" class="form-control checkgroup"  name="plano2" value=" ' . $plano .' "><font color="red">Selecione um plano!</font>';}else{ ?><input type="checkbox" class="form-control"  name="plano2" value="<?php echo $plano; ?>">PLANO<?php } ?></h6>
                                    ...
                                    <div class="col-sm-10 col-sm-offset-1">
                                        ...
                                        <div class="col-sm-4">
                                            <div class="choice" >
											 ...
											 <center><h6>R$ 50,00 <input type="checkbox" class="form-control checkgroup"  name="plano" value="15M"></h6></center>
										...
										<div class="col-sm-4">
											...
											<center><h6>R$ 75,00 <input type="checkbox" class="form-control checkgroup"  name="plano" value="30M"></h6></center>
