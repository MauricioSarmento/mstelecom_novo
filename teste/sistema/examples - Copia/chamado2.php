...
<?php
$n1=$_GET["id"];
$sql="SELECT * FROM chamado where id = $n1 ";
...
while($vreg=mysqli_fetch_row($res)){
	...
	$obs =$vreg[7];	}
?>
<div style="width:1000;" class="box-login"><center>
<form name="login" method="post" action="">
<input type="hidden" name="acao" value="nada" /> 
<table align="center" border="1" cellpadding="2" cellspacing="2">
<tr>
<td>Nome do cliente: </td><td>
<input type="text" name="nome" size="30" maxlength="25" value="<?php echo $nome; ?>" />
</td>
</tr>
<tr>
<td>Descrição do problema: </td><td><p>
<font color= 'red'><?php echo $reclamacao; ?></font></p>
</td>
</tr>
<tr>
<td>Data do chamado: </td><td>
<?php echo $data; ?>
</td>
</tr>
<tr>
<td>Data do atendimento: </td><td>
<input type="text" name="data_atendimento" size="6" maxlength="25" value="<?php echo date("d/m/Y"); ?>" />
</td>
</tr>
<tr>
<td>Tecnico: </td><td>
<?php echo $_SESSION['$vreg[2]']; ?>
</td>
</tr>
<tr>
<td>Solução:
</td>
<td>SIM: <input type="radio" name="solucao" value="2" />
NÃO: <input type="radio" name="solucao" value="1" />
</td>
</tr>
<tr>
<td>Observação: </td><td>
...
$atendimento=$_POST["data_atendimento"];}
if(!isset($descricao)){
$descricao=null;}
...
$id_servidor= $_SESSION['$id_servidor'];
$sql="UPDATE chamado SET status = $solucao, data_conclusao = '$atendimento', nome_tecnico='$tecnico', obs= '$descricao' WHERE id = '$id'";
$res=mysqli_query($con,$sql);


echo "Informações Salvas!<br>"; 
...
?>
<!-------------------------------------------- fim CADASTRO --------------------------------------------->
<?php echo "<a href='chamados.php'><button type='button' class='btn btn-primary'>VOLTAR</button></a></p><br>'"?>
