...
if($usuarioo == $n1 ){$status22 = "<font color='black'><strong><h2>STATUS: <font color='gree'>On". "-" . $uptime . "</strong></font></h2>";}else{$status22 = "<font color='black'><strong>STATUS= <font color='red'>Desconectado</strong></font></h2>";};
///////////////////////////////////////////////////////////////////
///////////////FIM DO SCRIPT///////////////////////////////////////
///////////////////////////////////////////////////////////////////
echo $status22;	
