...
<td>
<input type="text" name="cpf" size="30" maxlength="50"  onchange="carregatexto(this.value)" />
</td>
</tr>
<tr>
<td>Id do cliente:
</td><td>
<input type="text" name="apelido" size="30" maxlength="35" value="<?php echo $apelido;?>" onchange="carregatexto(this.value)" />
</td>
</tr>
<tr>
<td>E-mail:
</td><td>
<input type="text" name="email" size="30" maxlength="35"  onchange="carregatexto(this.value)" />
</td>
</tr>
<tr>
<td>Endereço:
