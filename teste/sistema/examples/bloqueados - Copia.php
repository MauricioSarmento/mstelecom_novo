...
echo "<td><a href='acao.php?id=$n'>"; echo "<font color='red'>" . $regtable['name'] . "</font><li></td>";	

echo "<td><a href='acao.php?id=$n'>"; echo "<font color='red'>" . $regtable['last-logged-out'] . "</font><li></td>	";
	
echo "<td><a href='acao.php?id=$n'>"; echo "<font color='red'>" . $regtable['profile'] . "</font><li></td><tr>";
...
echo "<td><a href='acao.php?id=$n'>"; echo "<font color='red'>"; echo $regtable['profile']; echo "</font><li></td><tr>";
