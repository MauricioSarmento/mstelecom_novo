...
<td>
<!------------>
<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#DESCON'>
DESCONECTAR
</button>
<!-- Modal -->
<div class='modal fade' id='DESCON' tabindex='-1' role='dialog' aria-labelledby='DESCON' aria-hidden='true'>
<div class='modal-dialog' role='document'>
<div class='modal-content'>
<div class='modal-header'>
<h2 class='modal-title' id='DESCON'>Deseja	desconectar a internet:?</h2>
<button type='button' class='close' data-dismiss='modal' aria-label='Fechar'>
<span aria-hidden='true'>&times;</span>
</button>
</div>
...
<div id="setTime"><?php   #echo $n1;   ?></div>
...
<a href='desconectar.php?id=$n1'> <button type='button' class='btn btn-warning'>Desconectar</button> " . $botao . "</a></p>";
?>
