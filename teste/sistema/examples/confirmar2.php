...
$sql="SELECT * FROM cadastro where id = '$n1' and id_servidor = '133'";
$res= mysqli_query($con,$sql);
$lin=mysqli_num_rows($res);
while($vreg=mysqli_fetch_row($res)){
$nome_id=$vreg[0];
...
<tr><h2><strong> <?php  echo $nome;  ?></strong> </h2>
</h4>Contato: <?php echo $telefone;  ?></h4>
<br>
<td>Plano:<font color='red'>*</font>
</td>
<td>
...
<td>
<input type="text" class="form-control" name="valor" value="<?php echo $valor;  ?>" size="7" maxlength="48" placeholder="Crie o usuario" onchange="carregatexto(this.value)" />
</td>
</tr>
<tr>
<td>
...
<td>
<input type="text" class="form-control" name="usuario" size="15" maxlength="48" placeholder="Crie o usuario" onchange="carregatexto(this.value)" />
</td>
</tr>
<td>
...
('133', default, '$nome','$usuario', '$email', '$telefone', '$instalacao','$rua',
'$numero','$complemento','$nome', '$plano', '$data', '3', '$valor', '$cpf'  );");
...
$sql="UPDATE cadastro SET id_cliente = '$id' WHERE nome = '$nome' and id_servidor = '133'";
$res=mysqli_query($con,$sql);
